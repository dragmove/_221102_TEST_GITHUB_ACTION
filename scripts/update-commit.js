...
function printIntegratedVersion(baseBranchName, triggerCommitHash, developCommitHash) {
  const [
    , prodVersion, baseCommitHash = developCommitHash
  ...
  if (baseBranchName === 'main') {
    ...
    intVersion = `${prodVersion}-alpha.${baseCommitHash.slice(0, 7)}-${ticket}.${date}`; // e.g. 1.2.3-alpha.1234567-epic.NOP-29.20230413T075727
  }
